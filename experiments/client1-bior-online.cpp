...
int main(int argc, char * argv[])
{
    ...
    try
    {
        asio::stream_file dealer{io_context, "bior.1", asio::stream_file::read_only};
        ...
        auto ret = async_online_bior<L,j,n>(dealer, peer, work_executor, 1, 100, count, asio::use_future);
